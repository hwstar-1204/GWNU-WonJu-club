...
from utils.save_conversation import save_conversation
...
# 의도 파악 모델
intent = IntentModel(model_name='model/intent/intent_model.h5', preprocess=p)
...
def to_client(conn, addr, params):
  ...
  try:
      ...
      # with open('./ai_chatbot/log.txt', 'a',encoding='utf-8') as log_file:
      #     log_file.write(log + '\n')
